      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead className="border-b border-slate-200 ">
            <tr>
              <th className="px-5 py-4 font-medium text-slate-600">Ürünler</th>

              <th className="px-5 py-4 font-medium text-slate-600">SKU</th>

              <th className="px-5 py-4 font-medium text-slate-600">Marka</th>

              <th className="px-5 py-4 font-medium text-slate-600">Kategori</th>

              <th className="px-5 py-4 font-medium text-slate-600">Fiyat</th>

              <th className="px-5 py-4 font-medium text-slate-600">Stok</th>

              <th className="px-5 py-4 font-medium text-slate-600">Durumu</th>
